...
use crate::constants::{DefaultOctTree, DefaultPieceHasher};
use crate::types::*;
...
impl PoRepConfig {
    ...
    pub fn get_cache_identifier(&self) -> Result<String> {
        ...
        Ok(
            <StackedCompound<DefaultOctTree, DefaultPieceHasher> as CacheableParameters<
                StackedCircuit<DefaultOctTree, DefaultPieceHasher>,
                _,
